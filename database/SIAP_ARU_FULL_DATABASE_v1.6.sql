-- =====================================================================
-- SIAP ARU v1.6 - FULL DATABASE (PHPMyAdmin Safe) (SCHEMA + OPERATIONAL USERS)
-- PT Aru Raharja
-- Database  : aru_siap
...
-- =====================================================================
-- 8. ATTACHMENT SURAT / DISPOSISI / PROSES APPROVAL
-- Surat asli tidak dikompresi. Lampiran tambahan/proses dikompresi bila efektif.
-- =====================================================================
CREATE TABLE IF NOT EXISTS `aru_siap`.`siap_attachments` (
  ...
  CONSTRAINT fk_siap_attach_action
    FOREIGN KEY (letter_action_id)
    REFERENCES `aru_siap`.`siap_letter_actions`(id)
    ON DELETE SET NULL,
...
VALUES
(UUID(),'Staff Administrasi','staff@aruraharja.co.id','$2b$12$ulWgiS3LhSuioG8icdZp0uVrrsNfGUtZcOPjAE3XCyW7aR4.5xeD2','STAFF','SDM & Umum',1,NOW(),NOW()),
(UUID(),'Manager Keu, SDM & Umum','manager@aruraharja.co.id','$2b$12$ulWgiS3LhSuioG8icdZp0uVrrsNfGUtZcOPjAE3XCyW7aR4.5xeD2','MANAGER','Keu, SDM & Umum',1,NOW(),NOW()),
(UUID(),'Manager Operasional','manager.ops@aruraharja.co.id','$2b$12$ulWgiS3LhSuioG8icdZp0uVrrsNfGUtZcOPjAE3XCyW7aR4.5xeD2','MANAGER','Operasional',1,NOW(),NOW()),
(UUID(),'Manager Gedung','manager.gedung@aruraharja.co.id','$2b$12$ulWgiS3LhSuioG8icdZp0uVrrsNfGUtZcOPjAE3XCyW7aR4.5xeD2','MANAGER','Gedung',1,NOW(),NOW()),
(UUID(),'Direktur Operasional','dirops@aruraharja.co.id','$2b$12$ulWgiS3LhSuioG8icdZp0uVrrsNfGUtZcOPjAE3XCyW7aR4.5xeD2','DIRECTOR_OPS','Direksi',1,NOW(),NOW()),
(UUID(),'Direktur Utama','dirut@aruraharja.co.id','$2b$12$ulWgiS3LhSuioG8icdZp0uVrrsNfGUtZcOPjAE3XCyW7aR4.5xeD2','PRESIDENT_DIRECTOR','Direksi',1,NOW(),NOW()),
(UUID(),'Finance','finance@aruraharja.co.id','$2b$12$ulWgiS3LhSuioG8icdZp0uVrrsNfGUtZcOPjAE3XCyW7aR4.5xeD2','FINANCE','Finance',1,NOW(),NOW())
ON DUPLICATE KEY UPDATE
  name=VALUES(name),
  password_hash=VALUES(password_hash),
  role=VALUES(role),
