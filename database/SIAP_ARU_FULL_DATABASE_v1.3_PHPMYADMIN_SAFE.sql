-- =====================================================================
-- SIAP ARU v1.3 - FULL DATABASE (PHPMyAdmin Safe) (SCHEMA + BOOTSTRAP)
-- PT Aru Raharja
-- Database  : aru_siap
...
--   4. Bootstrap 1 akun Root Admin
--   5. Bootstrap format nomor surat awal
--
-- TIDAK ADA:
--   - data surat dummy
--   - data Finance dummy
...
CREATE TABLE IF NOT EXISTS `aru_siap`.`siap_number_ledger` (
  ...
  UNIQUE KEY uq_siap_ledger_rendered
    (rendered_number),
...
VALUES (
  ...
  '$2b$12$jCNXdEMqDrpMJsui3y04puaQuJLFUvhrsVf0XF4fT7Gz0Z6mXC36u',
  'ROOT_ADMIN',
  'IT / System',
  1,
  NOW(),
...
-- di phpMyAdmin. Lihat file TUTORIAL_FIX_IMPORT_ARU_SIAP.md.
-- =====================================================================
